TRI63 driver controls MSP430 firmware README
...
- Unzip the tri63 firmware files into your working directly
- From a command prompt window (DOS box), and in your working directly, type "make" without the quotes
- The tools will produce a file called tri63.elf, containing the device firmware and debug info
- Connect to the TRI63 driver controls hardware with a TI programmaing adapter
...
- Provide 9-15V DC on the CAN bus cable connection to the driver controls
- At the command prompt window, type "msp430-jtag -l TIUSB -e tri63.elf" without the quotes
